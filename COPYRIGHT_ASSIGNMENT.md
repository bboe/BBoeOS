...
*This is the [Harmony Individual Contributor Assignment Agreement (HA-CAA-I)
v1.0](https://www.harmonyagreements.org/), July 4, 2011, with Project Harmony's
placeholders filled in for the BBoeOS project and with Section 2.3 Option Five
selected. The underlying text is © Project Harmony, licensed under [CC BY 3.0
Unported](https://creativecommons.org/licenses/by/3.0/).*

Thank you for your interest in contributing to the BBoeOS project, maintained by
Bryce Boe ("We" or "Us").
...
in the **How to Sign** section at the end of this document. This is a legally
...
the **Non-Owner Submissions** section at the end of this document.
...
(d) You have followed the instructions in the **Non-Owner Submissions** section
below, if You do not own the Copyright in the entire work of authorship
Submitted.
...
of the State of California, United States, excluding its conflicts of law
...
When You open Your first pull request, the [CLA Assistant
bot](https://cla-assistant.io/) will post a comment with a link to sign this
Agreement electronically. You will be asked to provide Your full legal name;
under the U.S. Electronic Signatures in Global and National Commerce Act
(E-SIGN), this constitutes a legally binding signature. Signing is a one-time
action — once Your GitHub account is on file, future Contributions are accepted
automatically under the same Agreement.

If You prefer not to sign through CLA Assistant, You may instead reply to Your
pull request with the following statement and Your full legal name:

> I, [full legal name], have read the BBoeOS Harmony Individual
> Contributor Assignment Agreement and I hereby agree to its terms for
> all present and future Contributions to the Project.

The Maintainer will record Your acceptance manually.

## Non-Owner Submissions

If You do not own the Copyright in the entire work of authorship You wish to
Submit, please **do not** open a pull request directly. Instead, open a GitHub
issue describing the work, its origin, and the license or other restrictions
that apply to it. The Maintainer will review the situation and determine whether
and how the work can be incorporated. This typically requires either a separate
agreement with the third-party copyright holder or evidence that the work is
already licensed under terms compatible with the project.

---

*Original Harmony CAA-I template © Project Harmony, licensed under [CC BY 3.0
Unported](https://creativecommons.org/licenses/by/3.0/). Modifications:
placeholder substitution for the BBoeOS project; Section 2.3 Option Five
selected; CC BY 4.0 specified for Media; "or Your Affiliates" removed from
Section 2.2 (this is the individual, not entity, version); signing flow added.*

...
| 31h   | rtc_datetime_legacy | BCD shape: CH=century, CL=year, DH=month, DL=day, BH=hours, BL=minutes, AL=seconds (transient; removed once cc.py supports `unsigned long`) |

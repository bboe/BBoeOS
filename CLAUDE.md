...
| `KERNEL_RESERVED_BASE` (~`0x2A000..0x2DFFF`) | `0xC002A000..` | 16 KB | `kernel_stack` (`KERNEL_RESERVED_BASE = page_align(0x20000 + kernel_size)`) | no |
| ~`0x2E000..0x2E5FF` | `0xC002E000..` | 1.5 KB | `net_receive_buffer` (NE2000 RX scratch) | no |
| ~`0x2E600..0x2EBFF` | `0xC002E600..` | 1.5 KB | `net_transmit_buffer` (NE2000 TX scratch) | no |
| ~`0x2F000..0x4EFFF` | `0xC002F000..` | 128 KB | `program_scratch` (vfs_load staging buffer; page-aligned above TX buf) | no |
| ~`0x4F000..0x4FFFF` | `0xC004F000..` | 4 KB | boot PD (`BOOT_PD_PHYS`; promoted to `kernel_pd_template`) | no |
| ~`0x50000..0x50FFF` | `0xC0050000..` | 4 KB | first kernel PT (`FIRST_KERNEL_PT_PHYS`) | no |
| ~`0x51000+` | `0xC0051000+` | -- | `LOW_RESERVE_BYTES` ceiling — all frames below this are pre-reserved at boot; everything past is owned by the bitmap allocator (subject to E820's reserved regions, including the VGA aperture at `0xA0000..0xFFFFF`) | -- |

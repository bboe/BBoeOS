...
- Kernel sector count is derived at runtime by the MBR: it reads `[kernel_bytes]` (a NASM-computed `kernel_end - 7E00h` placed at MBR offset 508) and shifts to get sectors.

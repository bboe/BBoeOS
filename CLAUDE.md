...
| ~`0x2E000..0x2EFFF` | `0xC002E000..` | 4 KB | boot PD (`BOOT_PD_PHYS`; promoted to `kernel_pd_template`) | no |
| ~`0x2F000..0x2FFFF` | `0xC002F000..` | 4 KB | first kernel PT (`FIRST_KERNEL_PT_PHYS`) | no |

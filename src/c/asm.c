...
asm(
    ...
    "\n"
    ";;; -----------------------------------------------------------------------\n"
    ";;; encode_rel8_jump lives in a cc.py-emitted C function near the\n"
    ";;; top of src/c/asm.c.\n"
    ";;; -----------------------------------------------------------------------\n"
    "\n"
    ";;; -----------------------------------------------------------------------\n"
    ...
    "\n"
    ";;; -----------------------------------------------------------------------\n"
    ";;; handle_add lives in a cc.py-emitted C function near the top\n"
    ";;; of src/c/asm.c.\n"
    ";;; -----------------------------------------------------------------------\n"
    "\n"
    ";;; -----------------------------------------------------------------------\n"
    ...
    "\n"
    ";;; -----------------------------------------------------------------------\n"
    ";;; handle_call lives in a cc.py-emitted C function near the top\n"
    ";;; of src/c/asm.c.\n"
    ";;; -----------------------------------------------------------------------\n"
    "\n"
    ";;; -----------------------------------------------------------------------\n"
    ";;; handle_cmp lives in a cc.py-emitted C function near the top\n"
    ";;; of src/c/asm.c.\n"
    ";;; -----------------------------------------------------------------------\n"
    "\n"
    ";;; -----------------------------------------------------------------------\n"
    ";;; handle_dec / handle_div / handle_inc live in cc.py-emitted C\n"
    ";;; functions near the top of src/c/asm.c.\n"
    ";;; -----------------------------------------------------------------------\n"
    "\n"
    ";;; -----------------------------------------------------------------------\n"
    ...
    "\n"
    ";;; -----------------------------------------------------------------------\n"
    ";;; handle_mov lives in a cc.py-emitted C function near the top\n"
    ";;; of src/c/asm.c.\n"
    ";;; -----------------------------------------------------------------------\n"
    "\n"
    ";;; -----------------------------------------------------------------------\n"
    ";;; handle_movzx lives in a cc.py-emitted C function near the\n"
    ";;; top of src/c/asm.c.\n"
    ";;; -----------------------------------------------------------------------\n"
    "\n"
    ";;; -----------------------------------------------------------------------\n"
    ...
    "\n"
    ";;; -----------------------------------------------------------------------\n"
    ";;; handle_or lives in a cc.py-emitted C function near the top\n"
    ";;; of src/c/asm.c.\n"
    ";;; -----------------------------------------------------------------------\n"
    "\n"
    ";;; -----------------------------------------------------------------------\n"
    ";;; handle_pop / handle_push live in cc.py-emitted C functions\n"
    ";;; near the top of src/c/asm.c.\n"
    ";;; -----------------------------------------------------------------------\n"
    "\n"
    ";;; -----------------------------------------------------------------------\n"
    ...
    "\n"
    ";;; -----------------------------------------------------------------------\n"
    ";;; handle_sbb / handle_shl / handle_shr live in cc.py-emitted C\n"
    ";;; functions near the top of src/c/asm.c.\n"
    ";;; -----------------------------------------------------------------------\n"
    "\n"
    ";;; -----------------------------------------------------------------------\n"
    ";;; handle_sub lives in a cc.py-emitted C function near the top\n"
    ";;; of src/c/asm.c.\n"
    ";;; -----------------------------------------------------------------------\n"
    "\n"
    ";;; -----------------------------------------------------------------------\n"
    ";;; handle_test / handle_xchg / handle_xor live in cc.py-emitted C\n"
    ";;; functions near the top of src/c/asm.c.\n"
    ";;; -----------------------------------------------------------------------\n"
    "\n"
    ";;; -----------------------------------------------------------------------\n"
    ";;; handle_unknown_word lives in a cc.py-emitted C function near\n"
    ";;; the top of src/c/asm.c.\n"
    ";;; -----------------------------------------------------------------------\n"
    "\n"
    ";;; -----------------------------------------------------------------------\n"
    ...
    "\n"
    ";;; -----------------------------------------------------------------------\n"
    ";;; parse_db / parse_directive / parse_line / parse_mnemonic /\n"
    ";;; parse_number / parse_operand / parse_register live in cc.py-\n"
    ";;; emitted C functions near the top of src/c/asm.c.\n"
    ";;; -----------------------------------------------------------------------\n"
    "\n"
    ";;; -----------------------------------------------------------------------\n"
    ";;; peek_label_target / resolve_label / resolve_value live in cc.py-\n"
    ";;; emitted C functions near the top of src/c/asm.c.\n"
    ";;; -----------------------------------------------------------------------\n"
    "\n"
    ";;; -----------------------------------------------------------------------\n"
    ...
    "\n"
    ";;; -----------------------------------------------------------------------\n"
    ";;; symbol_add / symbol_add_constant / symbol_lookup / symbol_set live\n"
    ";;; in cc.py-emitted C functions near the top of src/c/asm.c.\n"
    ";;; -----------------------------------------------------------------------\n"
    "\n"
    ";;; -----------------------------------------------------------------------\n"

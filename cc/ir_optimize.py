    ...
    def _forward_trivial_labels(self, body: list[ir.Instruction], /) -> list[ir.Instruction]:
        ...
        for instruction in body:
            ...
            if resolved == target:
                result.append(instruction)
                continue
            result.append(_replace_branch_target(instruction, new=resolved, old=target))
        return result
...
def _replace_branch_target(instruction: ir.Instruction, /, *, new: str, old: str) -> ir.Instruction:

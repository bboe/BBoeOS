#ifndef BBOEOS_UNISTD_H
#define BBOEOS_UNISTD_H
#include <stddef.h>
#include <sys/types.h>
 ...
 * libbboeos-side O_CREAT into a no-op.  Until now nothing in userland passed
 * O_CREAT through libbboeos; chocolate-doom's MUS-to-MID temp-file dance is

...
**asm (+63):** Phase 1 port wraps the remaining NASM source in a
...
`load_src_sector`, `skip_ws`, `skip_comma`, and the full `main` into pure C; eight dead `.error_*` labels, thirteen

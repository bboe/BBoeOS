...
# 512 B sector_buffer + page-align padding + 4 KB boot PD + 4 KB first
# kernel PT ≈ 16 KB = 0x4000.  Keeping the whole region under 0xA0000
# lets the OS boot under QEMU `-m 1` (1 MB total), where conventional
# RAM ends at 0x9FC00.
KERNEL_RESERVED_END=$(( KERNEL_RESERVED_BASE + 0x4000 ))

...
PROGRAMS="arp asm asmesc bigbss bigbss800 bits booltest cat cftest chmod cp date dns draw echo edit fctest gdemo gptest gtable hello inctest loop loop_array ls mkdir mv netinit netrecv netsend nullderef okptest pintest ping rm rmdir shell stackbomb stacktop uptime"

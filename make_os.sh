...
PROGRAMS="arp asmesc bits booltest cat cftest chmod cp date dns draw echo edit fctest gdemo gtable hello inctest loop loop_array ls mkdir mv netinit netrecv netsend pintest ping rm rmdir shell uptime"
